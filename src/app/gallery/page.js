...
export default function Gallery() {
  ...
  return (
    <div className="min-h-screen grid place-content-center bg-gradient-to-br from-stone-100 via-stone-300 to-stone-400 text-center py-20 lg:py-10">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 px-4 md:px-20 lg:px-32 lg:my-16 xl:my-20">
